...
@Service
public class GetPostFromUserUseCase {
    private final PostReadRepositoryPort postReadRepository;
    private final UserLookUpRepositoryPort userLookUpRepository;

    public GetPostFromUserUseCase(PostReadRepositoryPort postReadRepository, UserLookUpRepositoryPort userLookUpRepository) {
    ...
    public List<PostRowReadModel> execute(String publicId) {
        ...
        return this.postReadRepository.getPostsByUserId(userId);
    }
}
